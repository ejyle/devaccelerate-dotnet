...
namespace Ejyle.DevAccelerate.List.Culture
{
    ...
    {
        public DaTimeZoneManager(IDaTimeZoneRepository<TKey, TNullableKey, TTimeZone> repository)
            : base(repository)
        { }

        protected virtual IDaTimeZoneRepository<TKey, TNullableKey, TTimeZone> Repository
        {
            get
            {
                return GetRepository<IDaTimeZoneRepository<TKey, TNullableKey, TTimeZone>>();
            }
        }
