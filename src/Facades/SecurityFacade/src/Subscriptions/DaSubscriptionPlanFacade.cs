            ...
            foreach (var subscriptionPlan in subscriptionPlans)
            {
                ...
                if(billingCycles != null & billingCycles.Count > 0)
                {
                    ...
                    foreach (var billingCycle in billingCycles)
                    {
                        ...
                        billingCycleInfo.TrialDays = billingCycle.TrialDays;
